...
<div style="max-width: 90%; margin: 0 auto; padding-top: 5%;">
    ...
    <div align="center">
        <p><font color="white"><strong>review the MicroZoo</strong></font></p>
        <form method="POST" action="accept-review.php">
            <p><font color="white">Select Attraction: </font>
                <select name="selection" id="mydropdown" class="selectpicker" data-style="btn-primary">                       
                    <option value="MicroZoo">MicroZoo</option>
                </select>
            <br><br>
...
<div id="container">
    ...
    <!-- MicroZoo Reviews -->
    <p>MicroZoo: <span>Average 
    <?php for ($i=0; $i<$size; $i++) { ?>            
        <?php if($review_info[$i]["attraction"] === "MicroZoo") {
    ...
    <div style="padding-left: 3%; padding-right: 3%">
        ...
        <?php for ($i=($size-1); $i>=0; $i--) { ?>            
            <?php if($review_info[$i]["attraction"] === "MicroZoo") { ?>"<?php echo $review_info[$i]["review"];?>" -- <?php echo $review_info[$i]["firstName"]; ?><span> (<?php echo $review_info[$i]["stars"]; ?> stars)</span><br>
        <?php }
        }?>
        </p>
    </div>
