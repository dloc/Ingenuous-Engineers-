...
<div class="jumbotron">
    ...
    <?php }
        ...
        <p style="padding-top: 4%;">Congratulations, <?php echo $_SESSION['firstName']; ?>!<br><br>
            ...
            Please <a href="reviews.php">review</a> one of our many attractions.
        </p>
    <?php }
    else { ?>
        <p style="padding-bottom: 0;">Visit the gas giant on an all inclusive journey paid for in full by the generous people of Jupiter<br><br>
            sign up below
        </p>
        <form class="form-horizontal" action='confirm-booking.php' method="POST">
            <p style="padding-top: 4%;">
                <font color="white">Name: </font><i><?php echo $_SESSION['firstName']; ?></i> <br>
                <font color="white">Email: </font><i><?php echo $_SESSION['email']; ?></i> <br>
